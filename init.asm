...
int main(void)
{
  ...
  23:	0f 88 b7 00 00 00    	js     e0 <main+0xe0>
  {
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  ...
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 03 08 00 00       	push   $0x803
  5e:	6a 01                	push   $0x1
  60:	e8 5b 04 00 00       	call   4c0 <printf>
    printf(1, "1. Farzin Asadi\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 0f 08 00 00       	push   $0x80f
  6c:	6a 01                	push   $0x1
  6e:	e8 4d 04 00 00       	call   4c0 <printf>
    ///////////////
    pid = fork();
  73:	e8 e3 02 00 00       	call   35b <fork>
    if (pid < 0)
  ...
  7f:	78 28                	js     a9 <main+0xa9>
    {
      printf(1, "init: fork failed\n");
      exit();
    }
    if (pid == 0)
  81:	74 39                	je     bc <main+0xbc>
  ...
  88:	e8 de 02 00 00       	call   36b <wait>
  8d:	85 c0                	test   %eax,%eax
  8f:	78 b7                	js     48 <main+0x48>
  91:	39 c3                	cmp    %eax,%ebx
  93:	74 b3                	je     48 <main+0x48>
      printf(1, "zombie!\n");
  95:	83 ec 08             	sub    $0x8,%esp
  98:	68 4c 08 00 00       	push   $0x84c
  9d:	6a 01                	push   $0x1
  9f:	e8 1c 04 00 00       	call   4c0 <printf>
  a4:	83 c4 10             	add    $0x10,%esp
  a7:	eb df                	jmp    88 <main+0x88>
      printf(1, "init: fork failed\n");
  a9:	53                   	push   %ebx
  aa:	53                   	push   %ebx
  ab:	68 20 08 00 00       	push   $0x820
  b0:	6a 01                	push   $0x1
  b2:	e8 09 04 00 00       	call   4c0 <printf>
      exit();
  b7:	e8 a7 02 00 00       	call   363 <exit>
      exec("sh", argv);
  bc:	50                   	push   %eax
  bd:	50                   	push   %eax
  be:	68 60 0b 00 00       	push   $0xb60
  c3:	68 33 08 00 00       	push   $0x833
  c8:	e8 ce 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  cd:	5a                   	pop    %edx
  ce:	59                   	pop    %ecx
  cf:	68 36 08 00 00       	push   $0x836
  d4:	6a 01                	push   $0x1
  d6:	e8 e5 03 00 00       	call   4c0 <printf>
      exit();
  db:	e8 83 02 00 00       	call   363 <exit>
    mknod("console", 1, 1);
  e0:	50                   	push   %eax
  e1:	6a 01                	push   $0x1
  e3:	6a 01                	push   $0x1
  e5:	68 e8 07 00 00       	push   $0x7e8
  ea:	e8 bc 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  ef:	58                   	pop    %eax
  f0:	5a                   	pop    %edx
  f1:	6a 02                	push   $0x2
  f3:	68 e8 07 00 00       	push   $0x7e8
  f8:	e8 a6 02 00 00       	call   3a3 <open>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	e9 24 ff ff ff       	jmp    29 <main+0x29>
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 55 08 00 00       	mov    $0x855,%edx
        while(*s != 0){

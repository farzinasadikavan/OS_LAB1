...
struct
{
  ...
  uint w;    // Write index
  uint e;    // Edit index
  uint size; // input buf size
} input;

#define C(x) ((x) - '@') // Control-x
/////////////////////
char buf_copy[INPUT_BUF]; // a copy of input buf - used in Ctrl+A
int buf_copy_size = 0;    // size of buf_copy
int start_index = 0;      // for tracking the cursor after Ctrl+O
/////////////////////
